// app/vendedor/EditarPerfilVendedor.tsx
...
// Componente para los círculos flotantes del VENDEDOR
...
export default function EditarPerfilVendedor() {
  ...
  // Estados para los campos editables (SOLO ESTOS)
  ...
  const cargarPerfil = async () => {
    try {
      ...
      console.log("📊 Perfil VENDEDOR cargado:", data);
      setPerfil(data);
  ...
  const guardarCambios = async () => {
    try {
      ...
      Alert.alert(
        "✅ Perfil actualizado",
        "Los cambios de tu perfil de vendedor se guardaron correctamente",
        [
          { 
            text: "OK", 
            onPress: () => {
  ...
  if (loading) {
    return (
      <View style={styles.loadingContainer}>
        ...
        <Text style={styles.loadingText}>Cargando perfil de vendedor...</Text>
      </View>
    );
  }
      ...
      >
        ...
        >
          ...
          >
            ...
            <View style={styles.avatarContainer}>
              <View style={styles.avatar}>
                <Text style={styles.avatarText}>
                  {perfil.nombreEmpresa?.charAt(0) || perfil.nombre?.charAt(0)}
                </Text>
            ...
            <Text style={styles.headerLabel}>EDITANDO PERFIL COMERCIAL</Text>
            <Text style={styles.headerName}>
              {perfil.nombreEmpresa || `${perfil.nombre} ${perfil.apellido}`}
            </Text>
          ...
          <View style={styles.section}>
            <View style={styles.sectionHeader}>
              ...
              <View>
                ...
                <Text style={styles.sectionSubtitle}>Información del titular</Text>
              </View>
            </View>
            ...
            <View style={styles.card}>
              ...
              <View style={styles.inputGroup}>
                ...
                <Text style={styles.hint}>Fecha de nacimiento del titular</Text>
              </View>
            </View>
          </View>
            ...
            <View style={styles.card}>
              ...
              <View style={styles.inputGroup}>
                ...
                <View style={styles.lockedField}>
                  <Text style={styles.lockedText}>{perfil.nombreEmpresa || "No registrada"}</Text>
                  <View style={styles.lockBadge}>
                    <Text style={styles.lockBadgeText}>🔒</Text>
                  </View>
                </View>
                <Text style={styles.hint}>Registro legal de la empresa (No editable)</Text>
              </View>
              
              <View style={styles.inputGroup}>
                <Text style={styles.label}>RUC de la Empresa</Text>
                <View style={styles.lockedField}>
                  <Text style={styles.lockedText}>{perfil.rucEmpresa || "No registrado"}</Text>
                  <View style={styles.lockBadge}>
                    <Text style={styles.lockBadgeText}>🔒</Text>
                  </View>
                </View>
                <Text style={styles.hint}>Número de RUC registrado (No editable)</Text>
              </View>
              ...
              <View style={styles.inputGroup}>
                ...
                <Text style={styles.hint}>Contacto principal (No editable)</Text>
              </View>
              ...
              <View style={styles.inputGroup}>
                ...
                <TextInput
                  ...
                  blurOnSubmit={false}
                />
                <Text style={styles.hint}>Ubicación física del negocio</Text>
              </View>
              ...
              <View style={styles.inputGroup}>
                ...
                />
                <Text style={styles.hint}>Teléfono para contactos comerciales</Text>
              </View>
            </View>
          </View>

          {/* SECCIÓN 3: INFORMACIÓN ADICIONAL (SOLO LECTURA) */}
          <View style={styles.section}>
            <View style={styles.sectionHeader}>
              <View style={styles.sectionIconContainer}>
                <Text style={styles.sectionIcon}>📊</Text>
              ...
              <View>
                ...
                <Text style={styles.sectionSubtitle}>Datos de registro y estado</Text>
              </View>
            </View>
            ...
            <View style={[styles.card, styles.infoCard]}>
              <View style={styles.infoRow}>
                ...
                <Text style={styles.infoValue}>{perfil.idUsuario}</Text>
              </View>
              
              <View style={styles.infoRow}>
                <Text style={styles.infoLabel}>ID Vendedor:</Text>
                <Text style={styles.infoValue}>{perfil.idVendedor || "No asignado"}</Text>
              </View>
              ...
              <View style={styles.infoRow}>
                ...
                <View style={[
                  styles.statusBadge,
                  { backgroundColor: perfil.estado === 'Activo' ? '#D1FAE5' : '#FEE2E2' }
                ]}>
                  <Text style={[
                    styles.statusBadgeText,
                    { color: perfil.estado === 'Activo' ? '#065F46' : '#991B1B' }
                  ]}>
              ...
              <View style={styles.infoRow}>
                ...
                <View style={styles.ratingContainer}>
                  <Text style={styles.ratingText}>⭐ {perfil.calificacionPromedio?.toFixed(1) || '0.0'}</Text>
                  <Text style={styles.ratingSubtext}>/5.0</Text>
                </View>
              </View>
              ...
              <View style={styles.infoRow}>
                ...
                <Text style={styles.infoValue}>
                  {perfil.fechaRegistro ? new Date(perfil.fechaRegistro).toLocaleDateString() : 'No disponible'}
                </Text>
              </View>
            </View>
          </View>
          ...
          <View style={styles.footer}>
            ...
            <View>
              <Text style={styles.footerTitle}>Editando perfil de vendedor</Text>
